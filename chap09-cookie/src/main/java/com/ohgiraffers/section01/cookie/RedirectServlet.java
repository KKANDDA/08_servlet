...
public class RedirectServlet extends HttpServlet {
    ...
    // sendurl 자체가 url를 사용하기 때문에 doGet을 사용해야한다.
    @Override
...
* 그렇기 때문에 개인 PC는 그케 상관이 없지만 공용 PC 등 다른 사용자와 함께 쓰는 컴푸터이면 보안에 취약하다.
* 따라서 민감한 개인 정보를 취급하는 경우에는 쿠키보다는 세션을 이용한다.
* 세션은 쿠키와 유사한 형태로 저장되지만 서버(지금은 톰캣)에서 관리되므로 보안에 더 우수하다는 장점을 가진다.
* */